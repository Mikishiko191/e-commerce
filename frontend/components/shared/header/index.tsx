...
// TODO: make sure user can customize this and send from dashboard?
const navigation = {
  categories: [
    {
      name: 'Women',
        ...
        <div className="border-b border-gray-200 px-4 pb-14 sm:px-0 sm:pb-0">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex flex-1">
              <Link href="/">
                {/* TODO: make sure user can customize logo from admin panel */}
                <Image
                  alt="Logo"
                  src="https://www.reshot.com/preview-assets/icons/K5DQVANU3P/mill-K5DQVANU3P.svg"
                  width={32}
                  height={32}
            ...
            <div className="flex flex-1 items-center justify-end">
              ...
              <div className="group -m-2 flex items-center p-2 ml-3">
                <ModeToggle />
              </div>
